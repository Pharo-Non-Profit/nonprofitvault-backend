...
import (
	...
	t_s "github.com/Pharo-Non-Profit/nonprofitvault-backend/internal/app/howhear/datastore"
	"github.com/Pharo-Non-Profit/nonprofitvault-backend/internal/config/constants"
)

func (c *HowHearAboutUsItemControllerImpl) ListByFilter(ctx context.Context, f *t_s.HowHearAboutUsItemPaginationListFilter) (*t_s.HowHearAboutUsItemPaginationListResult, error) {
	...
	m, err := c.HowHearAboutUsItemStorer.ListByFilter(ctx, f)
	if err != nil {
...
func (c *HowHearAboutUsItemControllerImpl) PublicListAsSelectOptionByFilter(ctx context.Context, f *howhear_s.HowHearAboutUsItemPaginationListFilter) ([]*howhear_s.HowHearAboutUsItemAsSelectOption, error) {
