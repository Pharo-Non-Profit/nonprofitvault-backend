...
import (
	...
	sub_c "github.com/Pharo-Non-Profit/nonprofitvault-backend/internal/app/user/controller"
	sub_s "github.com/Pharo-Non-Profit/nonprofitvault-backend/internal/app/user/datastore"
...
func (h *Handler) Count(w http.ResponseWriter, r *http.Request) {
	...
	m, err := h.Controller.CountByFilter(ctx, f)
	if err != nil {
		httperror.ResponseError(w, err)
		return
	}

	MarshalCountResponse(m, w)
}

func MarshalCountResponse(res *sub_c.UserCountResult, w http.ResponseWriter) {
