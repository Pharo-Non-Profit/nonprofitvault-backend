...
func UnmarshalCreateRequest(ctx context.Context, r *http.Request) (*smartfolder_c.SmartFolderCreateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData smartfolder_c.SmartFolderCreateRequestIDO
...
func MarshalCreateResponse(res *smartfolder_s.SmartFolder, w http.ResponseWriter) {
