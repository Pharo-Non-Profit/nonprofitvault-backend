...
func UnmarshalUpdateRequest(ctx context.Context, r *http.Request) (*smartfolder_c.SmartFolderUpdateRequestIDO, error) {
	// Initialize our array which will store all the results from the remote server.
	var requestData smartfolder_c.SmartFolderUpdateRequestIDO
...
func MarshalUpdateResponse(res *smartfolder_s.SmartFolder, w http.ResponseWriter) {
